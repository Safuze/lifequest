...
const ALL_ACHIEVEMENT_DEFS = [
  ...
  // Золото
  { type: 'gold_500',    title: 'Богатей',           description: 'Заработано 500 монет',         icon: '🪙', rarity: 'common',       },
  { type: 'gold_2000',   title: 'Казначей',          description: 'Заработано 2000 монет',        icon: '💰', rarity: 'rare',         },
  { type: 'gold_10000',  title: 'Меценат',           description: 'Заработано 10000 монет',       icon: '💎', rarity: 'epic',         },
  { type: 'gold_25000',  title: 'Ротшильд',          description: 'Заработано 25000 монет',       icon: '🏦', rarity: 'legendary',    },
  // Уровни
